export default function Bounty() {
  return (
    <>
      ...
      <p style={{ color: "#5a7486", fontSize: "1.05rem", maxWidth: 720 }}>
        Skyline Airways handles payment information, passport data, and travel itineraries for millions of customers. We run a public bug bounty program.
      </p>
      <p style={{ color: "#5a7486", maxWidth: 720 }}>
      ...
      <div className="card">
        ...
        <p style={{ fontSize: "0.9rem", color: "#5a7486" }}>
