...
export default function Comments() {
  ...
  return (
    <>
      <h1>SkyClub Community</h1>
      <p style={{ color: "#5a7486", fontStyle: "italic", maxWidth: 680 }}>
        Trade tips, share trip reports, and connect with fellow Skyline travelers.
      </p>

      <div className="card">
        <h3 style={{ marginTop: 0 }}>Share your trip</h3>
        <form onSubmit={post}>
          ...
          <div style={{ marginTop: "1rem" }}>
            <button type="submit">Post Trip Report</button>
          </div>
        </form>
      </div>
      ...
      <div className="card" style={{ padding: 0 }}>
        ...
        {list.length === 0 && <p style={{ padding: "1.5rem", color: "#5a7486", fontStyle: "italic", textAlign: "center" }}>No posts yet.</p>}
      </div>
    </>
  );
}
